...
public class UtilGrafos {
    ...
    public static <T extends IGrafoDirigido> T cargarGrafoInvertido(String nomArchVert, String nomArchAdy, 
            boolean ignoreHeader, Class t  ) {
        ...
        for (String aristaString : aristas) {
            if ((aristaString != null) && (aristaString.trim() != "")) {
                String[] datos = aristaString.split(",");
                //Invierto los extremos de las aristas para que sean invertidas
