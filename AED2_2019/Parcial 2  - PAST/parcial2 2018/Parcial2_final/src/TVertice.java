...
public class TVertice implements IVertice, IVerticeKevinBacon {
    ...
    /**
     * Realiza una bpf con un límite de saltos, agregando a la coleccion dada.
     * 
     * @param visitados coleccion a la cual agregar los vertices descubiertos
