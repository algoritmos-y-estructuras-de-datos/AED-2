...
public class PD2 {
    public static void main(String[] args) {
        ...
        ManejadorArchivosGenerico.escribirArchivo("C:/Source/AED-2/UT3/pd2/src/main/java/ut3/mapasyhashing/salida.csv", lineas.toArray(new String[] {}));
    }
    
    public static void probarFactorCarga(double factorCarga, List<String> out) {
        String[] lineas = ManejadorArchivosGenerico.leerArchivo("C:/Source/AED-2/UT3/pd2/src/main/java/ut3/mapasyhashing/claves_insertar.txt");
