...
//             TreeMap<Comparable,TVertice> verticesOrdenados = new TreeMap<>(vertices);
//            HashMap<Comparable,TVertice> verticesOrdenados = new HashMap<>(vertices);
    ...
    public static IGrafoDirigido cargarGrafo(String nomArchVert, String nomArchAdy, boolean ignoreHeader) {
        ...
        return new TGrafoDirigido(verticesList, aristasList);
    }
}
